...
<body>
    ...
    <div class="content">
        ...
        <!-- Content -->
        <main class="p-6">
            <h1 class="titledashboard text-3xl font-bold mb-6">Resultados</h1>
            ...
            <div class="tabs-container">
                <div class="tabs-wrapper">
                    ...
                    <div class="browser-tab active" data-tab="Todo">
                        ...
                        <span class="tab-tooltip">Todos los registros</span>
                    </div>
                    ...
                    <div class="tab-content" id="bajo">
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="px-6 py-4" colspan="3">Casos de riesgo bajo</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="tab-content" id="moderado">
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="px-6 py-4" colspan="3">Casos de riesgo moderado</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="tab-content" id="alto">
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="px-6 py-4" colspan="3">Casos de riesgo alto</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
