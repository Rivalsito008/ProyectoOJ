                ...
                <div class="max-w-md">
                    <div class="relative">
                        ...
                        <input type="text" id="searchInput"
                            class="block w-full pl-10 pr-3 py-2 border-gray-200 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
