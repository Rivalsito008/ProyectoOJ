    ...
    <div class="content">
        ...
        <main class="p-6">
            ...
            <div class="fixed bottom-8 right-8 z-50">
                <button id="openQuestionBtn"
                    class="group relative w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium rounded-full shadow-lg hover:shadow-2xl transition-all duration-500 ease-out flex items-center justify-center overflow-hidden hover:w-52">
                    <div
            ...
            <div id="questionFormModal"
                class="fixed inset-0 z-50 bg-black bg-opacity-50 hidden items-center justify-center p-4">
                <div
                    class="modal-content bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full overflow-y-auto max-h-[90vh]">
                    <div
                        class="modal-header flex justify-between items-center p-5 rounded-t-2xl border-b dark:border-gray-700">
                        <h2 class="text-lg font-semibold flex items-center gap-2">
                            Nueva Pregunta
                        </h2>
                        <button id="closeQuestionBtn" class="text-gray-500 hover:text-red-500 transition"
                            aria-label="Cerrar">
                            ✕
                        </button>
                    </div>
                    ...
                    <section class="p-6 space-y-6">
                        <form id="questionForm" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="pregunta" name="pregunta" class="input-field w-full" rows="3"
                            ...
                            <div class="flex justify-end gap-3 pt-4">
                                ...
                                <button id="btnGuardarPregunta" type="submit"
