...
<body>
                ...
                <div class="max-w-md">
                    <div class="relative">
                        ...
                        <input type="text" id="searchInput"
                            ...
                            placeholder="Buscar denunciante por nombre...">
            ...
            <div id="modalAcciones" class="fixed inset-0 z-50 hidden">
                <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    <div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75"
                        onclick="cerrarModalAcciones()"></div>
            ...
            <div class="p-5 space-y-4 overflow-y-auto flex-1">
                ...
                <div
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-green-600 dark:text-green-400 mt-1">Riesgo mínimo. Situación controlada.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-yellow-600 dark:text-yellow-400 mt-1">Riesgo medio. Requiere seguimiento.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-orange-600 dark:text-orange-400 mt-1">Riesgo elevado. Medidas urgentes.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-red-600 dark:text-red-400 mt-1">Riesgo crítico. Intervención inmediata.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-blue-600 dark:text-purple-400 criteria-text leading-relaxed">
                        Los puntos se calculan basándose en la frecuencia e intensidad de las respuestas afirmativas a
                        las 38 preguntas del formulario de evaluación.
                    </p>
                </div>
            </div>
    ...
    <div id="modalDetalles"
        class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div
            class="modal-dialog bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden">
            <div class="p-6 overflow-y-auto max-h-[90vh]">
                <!-- Header del Modal -->
                <div
                    class="sticky top-0 bg-white dark:bg-gray-800 z-10 pb-4 border-b border-gray-200 dark:border-gray-600">
                    <div class="flex justify-between items-start">
                            ...
                            <div class="flex flex-wrap items-center gap-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-semibold text-gray-800 dark:text-white"
                                        id="detalleNombre">Cargando...</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-mono text-sm bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded"
                                        id="detalleNumeroCaso">Cargando...</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Nivel:</span>
                                    <span
                                        class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-white text-sm font-bold bg-gray-500"
                                        id="detalleNivelRiesgo">
                                        Cargando...
                                    </span>
                                </div>
                            </div>
                        ...
                        <button onclick="cerrarModalDetalles()"
                            class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 p-1 rounded">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12"></path>
                            </svg>
                ...
                <div class="space-y-4 mt-6">
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg hover:from-blue-100 hover:to-blue-200 dark:hover:from-blue-800/30 dark:hover:to-blue-700/30 transition-all"
                            data-target="seccionAdmin">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-blue-800 dark:text-blue-300">Información
                                    Administrativa</h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionAdmin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionAdmin"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Número de Caso:</span>
                                        <span class="ml-2 font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded"
                                            id="adminNumeroCaso">VIF-2025-00123</span>
                                    </p>
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Fecha de
                                            Denuncia:</span>
                                        <span class="ml-2" id="adminFechaDenuncia">2025-11-26</span>
                                    </p>
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Estado del
                                            Proceso:</span>
                                        <span
                                            class="ml-2 px-2 py-1 rounded text-xs font-medium bg-green-100 text-green-800"
                                            id="adminEstadoProceso">En investigación</span>
                                    </p>
                                </div>
                                <div class="space-y-2">
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Funcionario
                                            Asignado:</span>
                                        <span class="ml-2" id="adminFuncionario">Lic. Ana Rodríguez</span>
                                    </p>
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Unidad
                                            Asignada:</span>
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg hover:from-green-100 hover:to-green-200 dark:hover:from-green-800/30 dark:hover:to-green-700/30 transition-all"
                            data-target="seccionDenunciante">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-green-800 dark:text-green-300">Datos del
                                    Denunciante</h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionDenunciante" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionDenunciante"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Nombre
                                            Completo:</span>
                                    ...
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Estado
                                            Familiar:</span>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Nivel
                                            Educativo:</span>
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-lg hover:from-red-100 hover:to-red-200 dark:hover:from-red-800/30 dark:hover:to-red-700/30 transition-all"
                            data-target="seccionVictima">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-red-800 dark:text-red-300">Datos de la Víctima
                                </h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionVictima" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionVictima"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-3">
                                    <h5 class="font-semibold text-gray-800 dark:text-gray-200 border-b pb-2">Información
                                        Personal</h5>
                                ...
                                <div class="md:col-span-2 space-y-3">
                                    <h5 class="font-semibold text-gray-800 dark:text-gray-200 border-b pb-2">Salud y
                                        Descripción</h5>
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <span class="px-2 py-1 rounded text-sm bg-gray-100 text-gray-800"
                                                id="victimaEmbarazo">No</span>
                                        </div>
                                        <div>
                                            <p class="font-medium text-gray-700 dark:text-gray-300 mb-1">Enfermedad:</p>
                                            <span class="px-2 py-1 rounded text-sm bg-gray-100 text-gray-800"
                                                id="victimaEnfermedad">No</span>
                                        </div>
                                        <div>
                                            <p class="font-medium text-gray-700 dark:text-gray-300 mb-1">Discapacidad:
                                            </p>
                                            <span class="px-2 py-1 rounded text-sm bg-gray-100 text-gray-800"
                                                id="victimaDiscapacidad">Ninguna</span>
                                        </div>
                                    </div>
                                    <p class="mt-2"><span
                                            class="font-medium text-gray-700 dark:text-gray-300">Descripción
                                            Física:</span>
                                        <span class="ml-2 text-gray-600 dark:text-gray-400"
                                            id="victimaDescripcion">Estatura media, cabello castaño, ojos marrones, tez
                                            clara</span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg hover:from-purple-100 hover:to-purple-200 dark:hover:from-purple-800/30 dark:hover:to-purple-700/30 transition-all"
                            data-target="seccionAgresor">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-purple-800 dark:text-purple-300">Datos del Agresor
                                </h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionAgresor" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionAgresor"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <h5 class="font-semibold text-gray-800 dark:text-gray-200 border-b pb-2">Información
                                    ...
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">Vínculo con
                                            víctima:</span>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p><span class="font-medium text-gray-700 dark:text-gray-300">¿Cohabita con
                                            víctima?</span>
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-lg hover:from-orange-100 hover:to-orange-200 dark:hover:from-orange-800/30 dark:hover:to-orange-700/30 transition-all"
                            data-target="seccionViolencia">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-orange-800 dark:text-orange-300">Tipos de
                                    Violencia</h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionViolencia" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionViolencia"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="space-y-4">
                                <div id="violenciaTiposContainer">
                                    <div class="mb-4">
                                        <p class="font-medium text-gray-700 dark:text-gray-300 mb-2">Tipos
                                            identificados:</p>
                                        <div class="flex flex-wrap gap-2">
                                            <span
                                                class="inline-block px-3 py-1 rounded-lg text-sm font-medium bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-200">Psicológica</span>
                                            <span
                                                class="inline-block px-3 py-1 rounded-lg text-sm font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200">Económica</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <span class="text-gray-600 dark:text-gray-400"
                                            id="violenciaFrecuencia">Semanal</span>
                                    </div>
                                    <div>
                                        <p class="font-medium text-gray-700 dark:text-gray-300 mb-1">Lugar principal:
                                        </p>
                                        <span class="text-gray-600 dark:text-gray-400"
                                            id="violenciaLugar">Domicilio</span>
                                    </div>
                                    <div>
                                        <p class="font-medium text-gray-700 dark:text-gray-300 mb-1">¿Hay testigos?</p>
                                        <span class="text-gray-600 dark:text-gray-400" id="violenciaTestigos">Vecinos
                                            cercanos</span>
                                    </div>
                                    <div>
                                        <p class="font-medium text-gray-700 dark:text-gray-300 mb-1">Denuncias previas:
                                        </p>
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 rounded-lg hover:from-indigo-100 hover:to-indigo-200 dark:hover:from-indigo-800/30 dark:hover:to-indigo-700/30 transition-all"
                            data-target="seccionRiesgo">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-indigo-800 dark:text-indigo-300">Nivel de Riesgo y
                                    Cuestionario</h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionRiesgo" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionRiesgo"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="space-y-4">
                                <div
                                    class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-lg">
                                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        <div>
                                            <h5 class="font-bold text-gray-800 dark:text-white text-lg"
                                                id="riesgoNivelTexto">Nivel de Riesgo: Bajo</h5>
                                            <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">Puntuación obtenida
                                                en el cuestionario</p>
                                        </div>
                                        <div class="flex items-center gap-6">
                                            <div class="text-center">
                                                <div class="text-3xl font-bold text-green-600" id="riesgoPuntos">15
                                                </div>
                                                <div class="text-xs text-gray-600 dark:text-gray-400">Puntos</div>
                                            </div>
                                            <div class="text-center">
                                                <div class="text-3xl font-bold text-blue-600" id="riesgoRespuestas">8/37
                                                </div>
                                                <div class="text-xs text-gray-600 dark:text-gray-400">Respuestas Sí
                                                </div>
                                            </div>
                                            <div class="text-center">
                                                <div class="text-3xl font-bold text-purple-600" id="riesgoPorcentaje">
                                                    19%</div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                                            <div class="h-3 rounded-full transition-all duration-1000 bg-green-500"
                                                id="riesgoBarra" style="width: 19%"></div>
                                        </div>
                                ...
                                <div id="distribucionRespuestas">
                                    <div>
                                        <h5 class="font-semibold text-gray-800 dark:text-gray-200 mb-3">Distribución de
                                            respuestas por nivel:</h5>
                                        <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                                            <div class="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                                <div class="text-2xl font-bold text-green-700 dark:text-green-300">3/8
                                                </div>
                                                <div class="text-xs text-green-600 dark:text-green-400 mt-1">Nivel Bajo
                                                </div>
                                            </div>
                                            <div class="text-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                                                <div class="text-2xl font-bold text-yellow-700 dark:text-yellow-300">2/8
                                                </div>
                                                <div class="text-xs text-yellow-600 dark:text-yellow-400 mt-1">Moderado
                                                </div>
                                            </div>
                                            <div class="text-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                                                <div class="text-2xl font-bold text-orange-700 dark:text-orange-300">1/8
                                                </div>
                                                <div class="text-xs text-orange-600 dark:text-orange-400 mt-1">Alto
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                                <div class="text-2xl font-bold text-purple-700 dark:text-purple-300">0/5
                                                </div>
                                                <div class="text-xs text-purple-600 dark:text-purple-400 mt-1">Activador
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="accordion-section">
                        <button
                            class="accordion-header flex justify-between items-center w-full p-4 bg-gradient-to-r from-teal-50 to-teal-100 dark:from-teal-900/20 dark:to-teal-800/20 rounded-lg hover:from-teal-100 hover:to-teal-200 dark:hover:from-teal-800/30 dark:hover:to-teal-700/30 transition-all"
                            data-target="seccionContexto">
                            <div class="flex items-center gap-3">
                                ...
                                <h4 class="text-lg font-semibold text-teal-800 dark:text-teal-300">Contexto y
                                    Observaciones</h4>
                            </div>
                            <svg class="w-5 h-5 transform transition-transform accordion-icon"
                                data-target="seccionContexto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="seccionContexto"
                            class="accordion-content hidden p-4 bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
                            <div class="space-y-4">
                                <div>
                                    <h5 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">Descripción
                                        detallada de los hechos:</h5>
                                    <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                        <p class="text-gray-700 dark:text-gray-300 leading-relaxed"
                                            id="contextoDescripcion">El agresor realiza constantes comentarios
                                            descalificadores y controla los gastos del hogar, impidiendo que la víctima
                                            tenga acceso a dinero para sus necesidades básicas. Presenta comportamiento
                                            celoso y episodios de agresión verbal durante discusiones.</p>
                                    </div>
                                </div>

                                <div>
                                    <h5 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">Observaciones
                                        adicionales:</h5>
                                    <div
                                        class="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border-l-4 border-yellow-400">
                                        <p class="text-gray-700 dark:text-gray-300" id="contextoObservaciones">La
                                            víctima muestra signos de baja autoestima y dependencia emocional. Ha
                                            buscado apoyo en familiares cercanos pero muestra temor a denunciar
                                            formalmente. Se recomienda seguimiento psicológico y asesoría legal.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div
                    class="sticky bottom-0 bg-white dark:bg-gray-800 pt-4 border-t border-gray-200 dark:border-gray-600 mt-6">
                    <div class="flex flex-wrap justify-center gap-3">
                        <button id="btnVerDetalles"
                            class="action-btn-view flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm relative overflow-hidden">
                            Ver Respuestas
                        </button>
                        <button id="btnAcciones"
                            class="action-btn-procedure flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm relative overflow-hidden">
                            Acciones
                        </button>
                        <button onclick="cerrarModalDetalles()"
